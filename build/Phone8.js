...
export default class Phone8 extends Phone {
    constructor(game) {
        super(game);
        this.cat = new Gato('Lijkt deze persoon je aardig?', this.game.getCanvasWidth() - Phone.CAT_PHONE_X_POSITION, this.game.getCanvasHeight() - Phone.CAT_PHONE_Y_POSITION, this.game);
    }
    processInput() {
