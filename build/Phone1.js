...
export default class Phone1 extends Phone {
    constructor(game) {
        super(game);
        this.cat = new Gato('Hou je gebruikersnaam anoniem!', this.game.getCanvasWidth() - Phone.CAT_PHONE_X_POSITION, this.game.getCanvasHeight() - Phone.CAT_PHONE_Y_POSITION, this.game);
    }
    processInput() {
