...
export default class Level3 extends Level {
    ...
    constructor(game, shop) {
        super(game);
        this.cat = new Gato('Je kunt post`s niet van het internet verwijderen!', this.game.getCanvasWidth() - Level.CAT_X_POSITION, this.game.getCanvasHeight() - Level.CAT_Y_POSITION, this.game);
        this.shop = shop;
    }
    processInput() {
        this.game.setGoal(2);
    ...
    render(ctx, canvas) {
        ...
        Static.writeTextToCanvas(canvas, 'Level 4: een post plaatsen', canvas.width / 2, 50, 40, 'black');
