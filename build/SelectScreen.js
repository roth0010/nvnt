...
export default class SelectScreen extends Screen {
    ...
    render(ctx, canvas) {
        if (this.selected === false) {
            ...
            ctx.drawImage(this.waluigi, canvas.width / 6 - this.waluigi.width / 2, canvas.height / 2 - this.waluigi.height / 2);
            this.writeTextToCanvas(canvas, '1: Wa', canvas.width / 6, canvas.height - 50, 30, 'black');
            ctx.drawImage(this.waluigi, (canvas.width * 2) / 6 - this.waluigi.width / 2, canvas.height / 2 - this.waluigi.height / 2);
            this.writeTextToCanvas(canvas, '2: Lu', (canvas.width * 2) / 6, canvas.height - 50, 30, 'black');
            ctx.drawImage(this.waluigi, (canvas.width * 3) / 6 - this.waluigi.width / 2, canvas.height / 2 - this.waluigi.height / 2);
            this.writeTextToCanvas(canvas, '3: i', (canvas.width * 3) / 6, canvas.height - 50, 30, 'black');
            ctx.drawImage(this.waluigi, (canvas.width * 4) / 6 - this.waluigi.width / 2, canvas.height / 2 - this.waluigi.height / 2);
            this.writeTextToCanvas(canvas, '4: gi', (canvas.width * 4) / 6, canvas.height - 50, 30, 'black');
            ctx.drawImage(this.waluigi, (canvas.width * 5) / 6 - this.waluigi.width / 2, canvas.height / 2 - this.waluigi.height / 2);
