...
export default class Phone4 extends Phone {
    constructor(game) {
        super(game);
        this.cat = new Gato('The less info, the better!', this.game.getCanvasWidth() - Phone.CAT_PHONE_X_POSITION, this.game.getCanvasHeight() - Phone.CAT_PHONE_Y_POSITION, this.game);
    }
    processInput() {
